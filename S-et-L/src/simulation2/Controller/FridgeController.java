package simulation2.Controller;
...
extends AtomicES_Model{
	...
	public static final String	URI = "Fridge-Controller" ;
	...
	/**
	 * create an instance of OvenController model.
	 * 
		...
		) throws Exception
	{
		...
		this.delay = OvenController.STANDARD_DURATION ;
	}
	...
	{
		String varName =
					this.getURI() + ":" + OvenController.DELAY_PARAMETER_NAME ;
	...
	throws Exception
	{
		...
		return new SimulationReportI() {
					...
					public String toString() {
						return "Fridge_Controller_ModelReport()" ;
					}
