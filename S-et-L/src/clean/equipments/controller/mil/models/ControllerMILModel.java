package clean.equipments.controller.mil.models;
...
public class ControllerMILModel 
...
implements SGMILModelImplementationI{
	...
	// -------------------------------------------------------------------------
		...
		public static final String	URI = ControllerMILModel.class.getName() ;
			...
			) throws Exception
		{
			...
			this.delay = ControllerMILModel.STANDARD_DURATION ;
		...
		{
			String varName =
						this.getURI() + ":" + ControllerMILModel.DELAY_PARAMETER_NAME ;
