...
public class FridgeConsumptionMILModel 
extends AtomicModel
implements SGMILModelImplementationI{
	...
	public FridgeConsumptionMILModel(String uri, TimeUnit simulatedTimeUnit, SimulatorI simulationEngine) throws Exception {
	...
	public static final String URI = FridgeConsumptionMILModel.class.getName();
	public static final String		COMPONENT_HOLDER_REF_PARAM_NAME =
			"fridge consumption component reference" ;
