...
implements SGMILModelImplementationI{
	...
	public void openDoor() {
		...
		if(componentRef != null) {
			try {
				...
				componentRef.setEmbeddingComponentStateValue(Oven.Oven_STATE,convertOvenState(compressorActive));
	 ...
	 * @return
	 */
	private OvenMode convertOvenState(boolean activeCompressor) {
		if(compressorActive) return OvenMode.On;
		else return OvenMode.Off;
